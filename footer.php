...
<div class="bottom_footer_content">
    <div class="grid_16 alpha">         
        <div class="copyrightinfo">
            <p class="copyright">
            Copyright 2019
            <!-- <a href="<?php echo esc_url('http://wordpress.org/'); ?>" rel="generator"><?php _e('Powered by WordPress', 'compass');
    ?></a> -->
                <!-- <span class="sep">&nbsp;|&nbsp;</span>
                <?php
                printf(__('%1$s by %2$s.', 'compass'), 'Compass', '<a href="'.esc_url( "https://www.inkthemes.com/market/featured-content-slider-wordpress-theme/" ).'" rel="nofollow">InkThemes</a>');?> -->
            </p>
        </div>
    </div>
