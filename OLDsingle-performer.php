			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<?php if ( ! $is_page_builder_used ) : ?>
					...
					<div class="presenter_page_workshop_info">
						<?php
						$workshop_ids = get_field('2018_workshop_ids');
						...
						<div class="presenter_page_workshop_details">
							<a href="https://ohioldsmusic.org/schedule/?track=<?=strtolower($workshop_track)?>"><?=$workshop_track?></a> | <?=$workshop_session?> | <?=$workshop_location?>
						</div>
						<?php endforeach; ?>
					</div>
				...
				<div class="presenter_footer_links">
					<a href="https://ohioldsmusic.org/presenters/">See all Conference Presenters</a><br/>
